      ...
      <view class="stats-grid">
        ...
        <view class="stat-item">
          ...
          <text class="stat-value success"
            >{{ ((weeklyData.avgCalories / weeklyData.targetCalories) * 100).toFixed(1) }}%</text
          >
      ...
      const option = {
        ...
        yAxis: {
          ...
          splitLine: {
            lineStyle: {
              color: "#f0f5ff",
              type: "dashed", // 虚线保留，视觉干扰小
            },
          },
          axisLabel: {
            fontSize: 10, // Y轴字体可以更小
            color: "#999",
  ...
  const setCaloriesChart = (weeklyData) => {
    caloriesCharts.setOption({
      ...
      series: [
        ...
        {
          // 第二个系列为目标摄入量
          data: new Array(7).fill(weeklyData.targetCalories),
        },
      ],
			// -----------------------
    });
